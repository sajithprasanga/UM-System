...
<?php 
	...
	$user_list = '';
	//getting user list
	$quary = "SELECT * FROM user WHERE is_deleted=0 ORDER BY first_name";
	$users = mysqli_query($connection, $quary);
	...
	while ($user = mysqli_fetch_assoc($users)) {
		...
		$user_list .= "<td><a href=\"delete-user.php?user_id={$user['id']}\">Delete</td>";
		$user_list .= "</tr>";
	}
 ?>
 <!DOCTYPE html>
